    ...
    public class ControlBoxManager : IDisposable
    {
        ...
        public Rectangle SysBottomRect
        {
            get
            {
                ...
                {
                    Point offset = ControlBoxOffset;
                    Size size = _owner.SysBottomSize;
                    int x = MinimizeBoxVisibale ?
            ...
            Point mousePoint, MouseOperate operate)
        {
            ...
            Rectangle sysbottoneBoxRect = SysBottomRect;
            ...
            bool sysbottomVisibale = SysBottomVisibale;
            ...
            if (sysbottomVisibale)
            {
                if (sysbottomRect.Contains(mousePoint))
                {
                    ...
                    if (!_mouseDown)
                    {
                        ...
                        {
                            toolTip = _owner.SysBottomToolTip;
                        }
                        SysBottomState = ControlBoxState.Hover;
                    }
                    else
                    {
                        if (SysBottomState == ControlBoxState.PressedLeave)
                        {
