...
namespace CCWin
{
    public class SkinFormProfessionalRenderer : SkinFormRenderer
    {
            ...
            SkinFormControlBoxRenderEventArgs e)
        {
            ...
            switch (e.ControlBoxStyle)
            {
                ...
                case ControlBoxStyle.SysBottom:
                    RenderSkinFormSysBottomInternal(
                       g,
                       rect,
                       state,
                       active,
        ...
        private void DrawCaptionText(
            Graphics g, Rectangle textRect, string text, Font font, bool Effect,Color EffetBack, int EffectWidth,Color FrmColor)
        {
            if (Effect)
            {
                ...
                g.DrawImage(imgtext, textRect.X - EffectWidth / 2, textRect.Y - EffectWidth / 2);
            }
            else
            {
