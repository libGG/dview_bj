...
{
    public partial class MyWordControl : UserControl
    {
        public MyWordControl()
        {
            InitializeComponent();
        }
        ...
        public static  Microsoft.Office.Interop.Word.Application wd = null;
        ...
        public void LoadDocument(string t_filename)
        {
            ...
            if (wordWnd != 0)
            {
                ...
                try
                {
                    ...
                    wd.ActiveWindow.ActivePane.View.Type =WdViewType.wdWebView;
        ...
        public void RestoreWord()
        {
            try
            {
                ...
                //    try
                //    {
                //        wd.ActiveWindow.Application.CommandBars[(object)i].Enabled = true;
                //    }
                //    catch
                //    {
        ...
        private void MyWordControl_Resize(object sender, EventArgs e)
        {
            OnResize();
        }
    }
